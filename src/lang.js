const english = {
  ...
  rr: 'For the remarkable man who is a cut above the rest.',
  learn: 'Learn more.',
};
...
const bulgarian = {
  ...
  rr: 'Роберт Рюдгер - за отличителния мъж, който взима преднина пред останалите.',
...
const italian = {
  ...
  rr: "Per l'uomo straordinario che è una spanna sopra gli altri.",
